<%@ Page Language="C#" AutoEventWireup="true" CodeFile="testpannel.aspx.cs" Inherits="testpannel" %>
...
<body>
 ...
 <asp:Button ID="btnUpdate2" runat="server" Text="Update This Panel" OnClick="btnUpdate2_Click" />
     ...
     <table style="width:100%;">
         ...
         <tr>
             <td colspan="5">
                 <asp:CheckBoxList ID="CheckBoxList1" runat="server" Font-Size="15pt" OnSelectedIndexChanged="CheckBoxList1_SelectedIndexChanged" RepeatDirection="Horizontal" Width="1349px" AutoPostBack="True">
 ...
 <legend>Update Panel-2</legend>
  <asp:Label ID="lbl2" runat="server" ForeColor="red" />
     ...
     <table>
         ...
         <tr>
             <td>
                 <asp:Label ID="Label38" runat="server" Font-Size="15pt" Text="Examinations"></asp:Label>
             </td>
             <td>
                 <asp:CheckBoxList ID="CheckBoxList2" runat="server" Font-Size="15pt" OnSelectedIndexChanged="CheckBoxList2_SelectedIndexChanged" RepeatDirection="Horizontal" Width="342px">
         ...
         <tr>
             <td colspan="2" style="text-align: right">
                 <asp:Button ID="Button1" runat="server" Font-Size="15pt" OnClick="Button1_Click" style="font-weight: 700" Text="Reset" />
             </td>
             <td>&nbsp;</td>
             <td colspan="2">
